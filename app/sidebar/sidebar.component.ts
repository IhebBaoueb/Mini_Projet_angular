...
export const ROUTES: RouteInfo[] = [{
    ...
    },
    {
        ...
        collapse: 'universite',
        children: [
            {path: 'list-universite', title: 'listUniversite', ab:'LU'},
            {path: 'form-universite', title: 'formUniversite', ab:'FU'}
    ...
    },
    {
        ...
        type: 'sub',
        icontype: 'assignment',
        collapse: 'departement',
        children: [
            {path: 'list-departement', title: 'List Departement', ab:'LD'},
            {path: 'form-departement', title: 'Form Departement', ab:'FD'},
        ]
    },{
        path: '/etudiant',
        title: 'Etudiant',
